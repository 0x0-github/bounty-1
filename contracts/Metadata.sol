...
contract Metadata is Ownable {
        ...
        returns (string memory)
    {
        ...
        return string(
            abi.encodePacked(
                '<svg id="foxhen" width="100%" height="100%" version="1.1" ',
        ...
        returns (string memory)
    {
        ...
        string memory metadata = string(
            abi.encodePacked(
                ...
                isFox ? "Fox #" : "Hen #",
                tokenId.toString(),
                '", "description": "A sunny day in the Summer begins, ',
                'with the Farmlands and the Forest In its splendor, ',
                'it seems like a normal day. But the cunning planning of ',
                'the Foxes has begun, they know that the hens will do ',
                'everything to protect their precious $EGG but can they ',
                'keep them all without risk of losing them? A Risk-Reward ',
                'economic game, where every action matters. No IPFS. ',
                'No API. All stored and generated 100% on-chain", ',
